package org.osflash.dom.path.parser.expressions.opterators
{
	 ...
	 */
	public final class DOMPathLogicalAndExpression extends DOMPathExpression
													implements IDOMPathLeftRightNodeExpression
	{
		...
		public function DOMPathLogicalAndExpression(	left : IDOMPathExpression, 
		...
		{
			return DOMPathExpressionType.LOGICAL_AND;
		}

package org.osflash.dom.path.parser.expressions.opterators
{
	 ...
	 */
	public final class DOMPathGreaterThanExpression extends DOMPathExpression
													implements IDOMPathLeftRightNodeExpression
	{
		...
		public function DOMPathGreaterThanExpression(	left : IDOMPathExpression, 
		...
		{
			return DOMPathExpressionType.GREATER_THAN;
		}

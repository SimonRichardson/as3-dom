package org.osflash.dom.path.parser.expressions.opterators
{
	 ...
	 */
	public final class DOMPathGreaterThanOrEqualToExpression extends DOMPathExpression
														implements IDOMPathLeftRightNodeExpression
	{
		...
		public function DOMPathGreaterThanOrEqualToExpression(	left : IDOMPathExpression, 
		...
		{
			return DOMPathExpressionType.GREATER_THAN_OR_EQUAL_TO;
		}

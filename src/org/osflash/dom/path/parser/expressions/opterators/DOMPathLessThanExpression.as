package org.osflash.dom.path.parser.expressions.opterators
{
	 ...
	 */
	public final class DOMPathLessThanExpression extends DOMPathExpression
													implements IDOMPathLeftRightNodeExpression
	{
		...
		public function DOMPathLessThanExpression(	left : IDOMPathExpression, 
		...
		{
			return DOMPathExpressionType.LESS_THAN;
		}

package org.osflash.dom.path.parser.expressions.opterators
{
	 ...
	 */
	public final class DOMPathLessThanOrEqualToExpression extends DOMPathExpression
														implements IDOMPathLeftRightNodeExpression
	{
		...
		public function DOMPathLessThanOrEqualToExpression(	left : IDOMPathExpression, 
		...
		{
			return DOMPathExpressionType.LESS_THAN_OR_EQUAL_TO;
		}

package org.osflash.dom.path.parser.parselets
{
	...
	import org.osflash.dom.path.parser.expressions.DOMPathLogicalNotExpression;
	 ...
	 */
	public final class DOMPathLogicalNotParselet implements IDOMPathInfixParselet
	{
								...
								) : IDOMPathExpression
		{
			...
			return new DOMPathLogicalNotExpression(expression, right);
		}

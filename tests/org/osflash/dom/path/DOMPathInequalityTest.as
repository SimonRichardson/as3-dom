package org.osflash.dom.path
{
	 ...
	 */
	public class DOMPathInequalityTest
	{
		...
		[Test]
		public function path_select_node1_and_attribute_name_not_equals_node3() : void
		{
			...
			const result : Vector.<IDOMNode> = document.select('node1.(@value!="node3")');
			assertEquals('Result length should be 3', 3, result.length);
		}
		
		[Test]
		public function path_select_node1_and_attribute_name_not_equals_node3_in_context() : void
		{
			const node0 : IDOMNode = new DOMConditionalNode('node0', 'node0');
			const node1 : IDOMNode = new DOMConditionalNode('node1', 'node1');
			const node2 : IDOMNode = new DOMConditionalNode('node1', 'node2');
		...
		[Test]
		public function path_select_node1_and_attribute_name_not_equals_node3_in_document() : void
		{
			const node0 : IDOMNode = new DOMConditionalNode('node0', 'node0');
			const node1 : IDOMNode = new DOMConditionalNode('node1', 'node1');
			const node2 : IDOMNode = new DOMConditionalNode('node1', 'node2');
		...
		[Test]
		public function path_select_node1_and_attribute_name_not_equals_node1() : void
		{
			const node0 : IDOMNode = new DOMConditionalNode('node0', 'node0');
			const node1 : IDOMNode = new DOMConditionalNode('node1', 'node1');
			const node2 : IDOMNode = new DOMConditionalNode('node1', 'node2');
		...
		[Test]
		public function path_select_node1_and_attribute_name_not_equals_node1_in_context() : void
		{
			const node0 : IDOMNode = new DOMConditionalNode('node0', 'node0');
			const node1 : IDOMNode = new DOMConditionalNode('node1', 'node1');
			const node2 : IDOMNode = new DOMConditionalNode('node1', 'node2');
		...
		[Test]
		public function path_select_node1_and_attribute_name_not_equals_node1_in_document() : void
		{
			const node0 : IDOMNode = new DOMConditionalNode('node0', 'node0');
			const node1 : IDOMNode = new DOMConditionalNode('node1', 'node1');
			const node2 : IDOMNode = new DOMConditionalNode('node1', 'node2');
		...
		[Test]
		public function path_select_subnode1_and_attribute_name_not_equals_subnode4() : void
		{
			...
			const result : Vector.<IDOMNode> = document.select('node1/subnode1.(@name!="subnode4")');
			assertEquals('Result length should be 3', 3, result.length);
		...
		[Test]
		public function path_select_subnode1_and_attribute_name_not_equals_subnode4_in_context() : void
		{
			const node0 : IDOMNode = new DOMNode('node0');
			const node1 : IDOMNode = new DOMNode('node1');
			const node2 : IDOMNode = new DOMNode('node1');
		...
		[Test]
		public function path_select_subnode1_and_attribute_name_not_equals_subnode4_in_document() : void
		{
			const node0 : IDOMNode = new DOMNode('node0');
			const node1 : IDOMNode = new DOMNode('node1');
			const node2 : IDOMNode = new DOMNode('node1');
		...
		[Test]
		public function path_select_subsubnode1_and_attribute_name_not_equals_subnode2() : void
		{
			const node0 : IDOMNode = new DOMNode('node0');
			const node1 : IDOMNode = new DOMNode('node1');
			const node2 : IDOMNode = new DOMNode('node1');
			...
			const result : Vector.<IDOMNode> = document.select('node1/subnode1/subsubnode1.(@name!="subsubnode2")');
			assertEquals('Result length should be 4', 4, result.length);
		}
		
		[Test]
		public function path_select_subsubnode1_and_attribute_name_not_equals_subnode2_in_context() : void
		{
			const node0 : IDOMNode = new DOMNode('node0');
			const node1 : IDOMNode = new DOMNode('node1');
			const node2 : IDOMNode = new DOMNode('node1');
		...
		[Test]
		public function path_select_subsubnode1_and_attribute_name_not_equals_subnode2_in_document() : void
		{
			const node0 : IDOMNode = new DOMNode('node0');
			const node1 : IDOMNode = new DOMNode('node1');
			const node2 : IDOMNode = new DOMNode('node1');
